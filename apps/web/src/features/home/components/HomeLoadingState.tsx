    ...
    <div className="space-y-6 animate-pulse" aria-busy="true" aria-label="Loading workspace summary">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="h-36 rounded-lg border border-slate-200 bg-slate-100/70 p-4"></div>
          <div className="h-36 rounded-lg border border-slate-200 bg-slate-100/70 p-4"></div>
        </div>
      </section>

      {/* Primary Action Skeleton */}
      <div className="h-24 rounded-lg border border-slate-200 bg-slate-100/70 p-5"></div>
      ...
      <section className="space-y-4">
        ...
        <div className="h-44 rounded-lg border border-slate-200 bg-slate-100/70 p-4"></div>
      </section>
    </div>
  );
};
