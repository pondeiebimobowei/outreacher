      ...
      return await this.prisma.$transaction(
        async (tx: Prisma.TransactionClient) => {
          ...
          if (campaignMember.status !== CampaignMemberStatus.READY) {
            ...
            if (
              committedRecord &&
              committedRecord.targetId === campaignMemberId
            ) {
          ...
          const eligibilityResult =
            await this.sendEligibilityService.checkCampaignMemberEligibility({
              workspaceId,
          ...
          const emailSend =
            await this.sendEligibilityService.reserveSenderCapacityAndCreateEmailSend(
              tx,
              workspaceId,
