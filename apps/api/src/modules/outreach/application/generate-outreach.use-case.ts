...
export class GenerateOutreachUseCase {
  ...
  public async execute(
    ...
    // 2. Concurrency-safe atomic rate-limit check and job reservation/enqueueing inside DB transaction
    const result = await this.prisma.$transaction(async (tx: Prisma.TransactionClient) => {
      ...
      // Count generation calls in the past 1 hour for this workspace
